...
<body>
	<div class="container">
		...
		<form method="post">
			<h1>학생 등록</h1>
			<div>
				<label>ID</label> <input type="text" class="text100" name="id"
					value="<%=id%>" />
			</div>
			<div>
				<label>학번</label> <input type="text" class="text200"
			...
			<div>
				<label>학년</label> <input type="text" class="text100" name="year"
					value="<%= year %>" />
			</div>
